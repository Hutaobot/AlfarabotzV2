...
%readmore`.trimStart(),
  ...
  footer: '\n',
  after: `*Made by A7 RAFLI*
*Hu Tao Bot-MD* | %version
${'```%npmdesc```'}
`,
}
let handler = async (m, { conn, usedPrefix: _p }) => {
  try {
    ...
    conn.sendButton(m.chat, text.trim(), 'Made by A7 RAFLI', null, [['Donasi', '.donasi'],['Owner', '.owner']], m)
                    ...
                    templateMessage: {
                        hydratedTemplate: {
                            ...
                            hydratedButtons: [{
                                urlButton: {
                                    displayText: 'Website',
                                    url: 'https://linktr.ee/rafli_editz2'
                                }
                            }, {
                                quickReplyButton: {
                                    displayText: 'Donasi',
